...
3. **Arc 3 (PR #10, 2026-05-26)** — mcp-example name alignment + Scheme B+ across all 9 other example plugins + 2 component renames. Source research: `docs/archive/naming-conventions-2026-05-26/RESEARCH.md`.
